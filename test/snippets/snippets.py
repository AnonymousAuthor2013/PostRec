...
def test2():
    ...
    for ds in dataSource:
        data_dir=os.path.join(post_rec.DataPath, "inference_pair/test-" + ds + ".txt")
        with open(data_dir,"r") as f:
            data.extend(f.readlines())
        data_dir=os.path.join(post_rec.DataPath, "inference_pair/train-" + ds + ".txt")
        with open(data_dir,"r") as f:
            data.extend(f.readlines())
    ...
    data_dir=os.path.join(post_rec.DataPath, "inference_pair/train.txt")
    with open(data_dir,"w") as f:
        f.writelines(train)
    data_dir=os.path.join(post_rec.DataPath, "inference_pair/test.txt")
    with open(data_dir,"w") as f:
        f.writelines(test)
    data_dir=os.path.join(post_rec.DataPath, "inference_pair/train-all.txt")
    with open(data_dir,"w") as f:
        f.writelines(data)
