...
def pairRelation(distanceData:list,nodes):
    labeled_link_file= post_rec.DataPath + "linkData/" + dbName.lower() + '-labelPair.json'
...
def main():
    ...
    distance_file= post_rec.DataPath + "linkData/" + dbName.lower() + '-%dgraph.json' % maxPathLength
    distance_data=[]
    nodes=[]
