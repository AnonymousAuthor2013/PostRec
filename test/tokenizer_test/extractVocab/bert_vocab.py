...
import os
import post_rec
from post_rec.tokenizers.tokenizer import Seq2SeqAdapterTokenizer

def extractVocab(model_path = post_rec.BertLargeUnCased):
    ...
    vocab_file = os.path.join(post_rec.BertRoot, "vocab.txt")
