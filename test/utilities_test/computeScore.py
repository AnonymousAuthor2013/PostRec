from post_rec.Utility.metrics import LanguageMetrics
import numpy as np
import argparse
import post_rec
...
if __name__ == '__main__':
    ...
    maxLen=200
    parser.add_argument("--reference_file", type=str, default=post_rec.DataPath + "seq2seq/valid-dst")
    #parser.add_argument("--maxLen",type=int,default=50)
    parser.add_argument("--summary_file", type=str, default=post_rec.DataPath + "predictions/predict-%d.txt" % maxLen)
