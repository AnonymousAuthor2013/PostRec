...
from post_rec import retrievers
from post_rec import tokenizers
import post_rec
from post_rec.DataSet.DBLoader import MongoStackExchange,MongoWikiDoc
...
def count(ngram, hash_size, doc_id):
    ...
    counts = Counter([retrievers.utils.hash(gram, hash_size) for gram in ngrams])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', type=str, default=post_rec.DataPath,
    ...
    retrievers.utils.save_sparse_csr(filename, tfidf, metadata)
